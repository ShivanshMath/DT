...
const items = [
  ...
  },
  {
    ...
    children: [
      {
        key: "/dt/network/simulation/core-engine",
        label: "Core Engine",
        // icon: <i className="fa-solid fa-gear"></i>,
      },
      {
        key: "/dt/network/simulation/what-if-engine",
        label: "What-if Engine",
        // icon: <i className="fa-regular fa-life-ring"></i>,
        // disabled: true,
      },
      {
        key: "/dt/network/simulation/optimization-engine",
        label: "Optimization Engine",
        // icon: <i className="fa-solid fa-thumbs-up"></i>,
        // disabled: false,
      },
      {
        key: "/dt/network/simulation/root-cause-engine",
...
export default NetworkRootLayout;
